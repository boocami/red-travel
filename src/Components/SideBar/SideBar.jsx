...
import { ManuItems } from "../../Utilidades/MenuItems";

const SideBar = () =>{
    return (
<div>
    <aside className="w-64 px-8 py-4 bg-gray-100 border-r overflow-auto h-full">
    <a className="flex items-center w-full px-3 mt-3" href="#">
        ...
        {/* <img className="rounded-full" src="https://i.pravatar.cc/100" alt="logo"/> */}
        {/* <h3>Traveling</h3>
        <nav className="mt-8">
            <h3 className="text-xs font-semibold text-gray-600 uppercase tracking-wide text-left">Issues</h3>
            <div className="mt-2 -mx-3">
                {ManuItems.map((item) => (
                      <a key={item.key} href={item.url} className="flex justify-between items-center px-3 py-2 rounded-lg">
            ...
            <button className=" mt-4 -ml-1 flex items-center text-sm font-medium text-gray-600">
                <svg className="h-5 w-5 text-gray-500" viewBox="0 0 24 24" fill="none">
                    <path stroke="currentColor" strokeWidth="2" strokeLinecap="round" d="M12 7v10m5-5H7"></path>
                </svg>
